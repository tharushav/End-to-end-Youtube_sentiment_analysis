...
def preprocess_data(df: pd.DataFrame) -> pd.DataFrame:
    ...
    try:
        ...
        # Removing rows with empty strings - using correct column name
...
def main():
    try:
        ...
        # Load data using relative path and the load_data function
        data_file_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../../YoutubeCommentsDataSet.csv')
