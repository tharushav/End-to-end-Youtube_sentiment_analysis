...
def apply_bow(train_data: pd.DataFrame, max_features: int, ngram_range: tuple) -> tuple:
    """Apply Bag of Words with ngrams to the data."""
    try:
        ...
        logger.debug(f"Bag of Words transformation complete. Train shape: {X_train_bow.shape}")
...
def main():
    try:
        ...
        # Apply Bag of Words feature engineering on training data
